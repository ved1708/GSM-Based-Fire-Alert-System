...
char phone_no[]="+917004634985"; //change +92 with country code and 3378655465 with phone number to sms

#define sensorPin 2 // choose the input pin (for Fire sensor)  

#define buzzer 3 // choose the pin for the Buzzer
#define led_M  4 // choose the pin for the Green LED Message active indication
#define led_C  5 // choose the pin for the Green LED Call Active indication
#define led_S  6 // choose the pin for the Red LED Fire detection indication
